...
public class SimpleCacheTest extends TestCase {
	...
	public void testAdds() {
		Cache<String> cache = new SimpleCache<>(2, TimeUnit.SECONDS);
	...
	public void testCacheExpiry() throws InterruptedException {
		...
		System.out.println(String.format("isNodeEvicted= %s,  nodeAvailableEarlier = %s", isNodeEvicted, nodeAvailableEarlier));
		assertTrue(isNodeEvicted&& nodeAvailableEarlier);
	}
	@Test
	public void testRemove() {
		Cache<String> cache = new SimpleCache<>(20, TimeUnit.SECONDS);
		cache.add("1");
